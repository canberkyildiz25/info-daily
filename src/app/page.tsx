        ...
        <div className="flex gap-3 overflow-x-auto pb-2">
          {CATEGORIES.map(cat => (
            <Link
              ...
              className="flex items-center gap-2 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-full px-4 py-2 text-sm font-medium text-gray-700 dark:text-slate-300 hover:border-blue-400 dark:hover:border-blue-500 hover:text-blue-600 dark:hover:text-blue-400 whitespace-nowrap transition-colors shadow-sm flex-shrink-0"
            >
