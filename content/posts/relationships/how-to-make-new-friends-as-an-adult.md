...
- **Join a recurring class or group.** Think weekly yoga, a book club, a running group, a pottery class, or a language exchange meetup. The key word is *weekly* — or at least regular.
...
The goal isn't to force a connection in one sitting. It's to let familiarity build naturally. Psychologists call this the **mere exposure effect** — the more we see someone, the more we tend to like them.
...
1. **After a good conversation, suggest a specific plan.** Instead of saying "We should hang out sometime," try "I'm checking out that new taco place on Saturday — want to come?"
2. **Exchange numbers or social media handles.** It sounds simple, but many promising connections die because no one takes this step.
3. **Follow up within 48 hours.** Send a quick text referencing something you talked about. "Hey, I looked up that podcast you mentioned — it's great!"
4. **Be the organizer.** Host a casual game night, a hike, or a potluck. People love being invited to things even if they can't always attend.

It will feel vulnerable. It might even feel a little like dating. That's completely normal. Push through the discomfort — it gets easier every time.
...
These kinds of questions invite people to share something meaningful, and that's where real connection begins. Research by psychologist Arthur Aron has shown that mutual self-disclosure — gradually sharing more personal thoughts and feelings — is one of the most reliable pathways to closeness.
...
- **Bumble BFF** — A friend-finding mode within the Bumble app that works similarly to its dating counterpart.
- **Meetup** — One of the oldest and most reliable platforms for finding local interest-based groups.
- **Peanut** — Designed for mothers looking to connect with other moms.
- **Nextdoor** — Great for finding neighborhood events and community groups.
...
Making a new friend is only half the battle. Keeping that friendship alive requires ongoing effort — especially in the early stages when the relationship is still fragile.
...
- **Be patient.** Research suggests it takes roughly **200 hours of time spent together** for someone to become a close friend, according to a 2018 study by University of Kansas professor Jeffrey Hall. That's a lot of hours — so give the process time.

## Manage Your Expectations and Be Kind to Yourself

Not every person you meet will become your best friend. Some connections will fizzle, and that's perfectly okay. Adult friendship is partly a numbers game — you need to meet a lot of people to find the few who really click.

It's also worth examining any internal barriers that might be holding you back:

- **Perfectionism** — Waiting for the "perfect" friend instead of appreciating good-enough connections.
- **Fear of rejection** — Assuming people don't want to hear from you (they usually do).
- **Comparing to past friendships** — New friends won't be like your college roommate, and that's fine. They'll bring something different.
