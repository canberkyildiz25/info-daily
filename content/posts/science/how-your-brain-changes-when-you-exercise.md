...
|---------------|-----------------------|
| Aerobic (running, cycling) | Neurogenesis, BDNF, hippocampus growth |
| Resistance training | Executive function, prefrontal cortex |
| Yoga/tai chi | Amygdala regulation, anxiety reduction |
| HIIT | Acute cognitive performance, norepinephrine |
| Dance | Spatial reasoning, coordination networks |
