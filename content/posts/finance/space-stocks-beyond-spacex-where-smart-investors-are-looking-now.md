...
- **ARK Space Exploration & Innovation ETF (ARKX)** — Managed by Cathie Wood's team, this fund includes a mix of space-adjacent companies across launch, satellites, and enabling technologies.
- **Procure Space ETF (UFO)** — More narrowly focused on companies deriving significant revenue from space-related activities, including satellite operators and ground equipment manufacturers.
- **SPDR S&P Kensho Final Frontiers ETF (ROKT)** — Blends space and deep-sea exploration themes, offering broader frontier-technology exposure.
...
1. **Capital intensity** — Building and launching satellites costs hundreds of millions of dollars. Many space companies burn cash for years before reaching profitability.
2. **Technical risk** — Rockets explode. Satellites fail. One bad mission can crater a stock price overnight.
3. **Regulatory uncertainty** — Spectrum allocation, launch licensing, and international space law are still evolving.
4. **Concentration risk** — Many smaller space companies depend heavily on a single customer (often the U.S. government) or a single product line.
5. **Valuation stretch** — Hype-driven sectors tend to price in years of future growth. Make sure you're not overpaying for a dream.
...
You don't need to wait for a SpaceX IPO to invest in space. The opportunity is already here — it's just a matter of knowing where to look.
