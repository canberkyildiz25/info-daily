...
1. Test **connected directly via ethernet cable** to your router — this tells you what speed your ISP is actually delivering
2. Test on **Wi-Fi in the same room as the router**
3. Test in the **problem locations** where speeds are slow
