---
title: "Keyboard Shortcuts That Will Save You Hours Every Week"
...
| Zoom in/out | Ctrl+Plus / Ctrl+Minus | Cmd+Plus / Cmd+Minus |
...
| Switch to specific tab | Ctrl/Cmd+1 through 9 |
| Address bar focus | Ctrl/Cmd+L |
| New private/incognito window | Ctrl/Cmd+Shift+N |
| Bookmark current page | Ctrl/Cmd+D |
| Full screen | F11 (Windows) / Ctrl+Cmd+F (Mac) |
| Developer tools | F12 (Windows) / Cmd+Option+I (Mac) |
...
| Action | Shortcut |
|--------|----------|
| Heading 1/2/3 | Ctrl/Cmd+Alt+1/2/3 |
| Clear formatting | Ctrl/Cmd+\ |
| Insert link | Ctrl/Cmd+K |
| Comment | Ctrl/Cmd+Alt+M |
| Word count | Ctrl/Cmd+Shift+C |
