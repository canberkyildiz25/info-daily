...
**How to use it**: When something comes to your attention — an email, a quick request, a small decision — ask yourself: "Can I finish this in under two minutes?" If yes, do it now. If no, defer it intentionally.
...
Work in 25-minute focused blocks separated by 5-minute breaks. After four blocks, take a longer 15–30 minute break.
...
**How to use it**: Pick a single task. Set a timer for 25 minutes. Work on only that task until the timer goes off. Take a 5-minute break (walk, stretch, drink water — not phone scrolling). Repeat. The key is the full commitment to one task per Pomodoro and the genuine mental rest during breaks.

The technique was developed by Francesco Cirillo in the 1980s using a tomato-shaped kitchen timer (pomodoro = tomato in Italian). The specific 25/5 split isn't sacred — some people work better with 50/10 or 90/15 — but the principle of focused blocks with structured recovery is robust.
...
**How to use it**: The night before, identify the single most important task for the next day — the one that will move something significant forward. Do that first, before email, before Slack, before coffee meetings. Give it at least 60–90 uninterrupted minutes.

The research on this is particularly strong for deep work, creative tasks, and anything requiring complex reasoning.

## 5. Weekly Review (GTD)

Once a week, spend 30–60 minutes reviewing everything: your task lists, projects, calendar, commitments, and goals.

This is the most underrated productivity habit. Most people live in reactive mode — responding to whatever arrives — and never surface to see if they're working on the right things. The weekly review creates that perspective.
...
**How to use it**: During any important work period, put your phone in another room or on Do Not Disturb (not just silent). Close email and Slack. Use website blockers (Freedom, Cold Turkey, or Focus) to block social media and news. Batch communication — check email at 9am, noon, and 4pm, not continuously.
