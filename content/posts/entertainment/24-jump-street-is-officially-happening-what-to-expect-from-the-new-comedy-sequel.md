...
The *Jump Street* franchise has always been a Hollywood anomaly. When *21 Jump Street* hit theaters in 2012, few expected a reboot of an '80s TV procedural to become one of the sharpest, most self-aware comedies in recent memory. It earned over $200 million worldwide on a modest $42 million budget, according to Box Office Mojo — a return that practically guaranteed a sequel.

*22 Jump Street* arrived in 2014 and did what few comedy sequels manage: it was arguably even funnier than the original. By leaning hard into meta-humor about sequels themselves — recycled plots, inflated budgets, diminishing returns — directors Phil Lord and Christopher Miller turned what could have been a lazy retread into a comedic masterpiece. The film grossed over $331 million globally.

Then came the infamous end-credits sequence, which rattled off fake sequels from *23 Jump Street* all the way to *40 Jump Street*, including crossovers with *Men in Black* and a medical school spinoff. It was hilarious — and it also seemed to close the door on a real sequel. Why make another one when you've already made the definitive joke about unnecessary sequels?

And yet, here we are. Over a decade later, *24 Jump Street* is happening. And honestly? The timing might be perfect.
...
**Ice Cube** is also expected to reprise his role as Captain Dickson, the perpetually furious boss whose rage somehow escalates with each installment.

### Phil Lord and Christopher Miller Are Involved

While it hasn't been confirmed whether Lord and Miller will direct (they've been juggling multiple projects across film and television), both are attached as producers and are reportedly heavily involved in shaping the story. Their fingerprints on the franchise's tone — irreverent, self-aware, surprisingly heartfelt — have been essential to its success.
...
### The Plot Takes a Bold New Direction

Details are being kept tightly under wraps, but here's what's been pieced together from various industry sources:
...
- **The comedy will reportedly lean into themes of nostalgia, aging, and irrelevance** — which, for a franchise that's been dormant for over a decade, feels incredibly fitting.
...
Here's the thing about comedy sequels that arrive years after the original: they almost always fail. For every *Top Gun: Maverick* (action, but the principle applies), there are a dozen *Zoolander 2*s and *Dumb and Dumber To*s that feel like sad victory laps.
...
1. **Expect the meta-humor to evolve, not repeat.** The "we're making a sequel" jokes worked brilliantly in *22 Jump Street*, but doing the same thing a third time would fall flat. Expect the self-awareness to target legacy sequels, franchise fatigue, and the culture of reboots.
2. **The Jenko-Schmidt bromance will be front and center.** Tatum and Hill's chemistry is the franchise's beating heart. Their dynamic — the jock and the nerd who genuinely love each other — is what elevates the films beyond standard buddy-cop fare.
3. **Don't expect a *Men in Black* crossover.** Despite years of rumors about a *Jump Street*/*MIB* mashup (which was genuinely in development at one point), that concept appears to be dead. *24 Jump Street* is going its own way.
4. **It'll probably be rated R.** Both previous films earned their R ratings, and there's no indication this installment will soften its edge.
...
- **Audiences still want to see comedies on the big screen** — they just need a reason to show up.
