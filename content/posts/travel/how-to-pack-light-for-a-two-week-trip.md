...
The biggest obstacle to packing light isn't your wardrobe — it's your mindset. Most of us pack based on "what if" scenarios. *What if there's a fancy dinner? What if it rains? What if I want to go hiking?* The result is a bloated suitcase filled with items that never leave the bag.
...
- **A carry-on sized backpack or rolling bag** (around 40–45 liters or roughly 22" x 14" x 9")
...
This is the single most powerful packing strategy. A capsule wardrobe is a small collection of versatile clothing where every piece works with every other piece. You're not packing outfits — you're packing **interchangeable items**.
...
- **Tops:** 4–5 shirts or blouses (mix of short and long sleeve)
...
- **Use solid toiletries** — shampoo bars, solid conditioner, bar soap, and solid deodorant eliminate liquid restrictions entirely
...
- **Skip what your accommodation provides** — most hotels and even hostels supply shampoo, conditioner, and body wash
- **Embrace multi-use products** — a tinted moisturizer with SPF replaces three separate products
...
- **More than two pairs of shoes** — shoes are the heaviest, bulkiest items in any bag
- **Full-sized books** — use an e-reader or your phone
- **Excessive jewelry** — one or two versatile pieces are plenty
...
Before anything goes into your bag, lay every single item on your bed. Look at it critically. Now remove at least three things. Seriously — you won't miss them.
